    ...
    UUPSUpgradeable
{
    ...
    /**
     * @dev Allows anyone to liquidate an expired or soon-to-expire NFT position of another user.
     * Checks if NFT is whitelisted and if the position owner has staked this NFT.
