...
contract NFTStakingAndBorrowingTest is Test {
    ...
    function test_liquidate_case_03() public {
        ...
        uint256 maxBorrow = nftStaking.calculateMaxBorrow(
            userStats.staked, 
            block.timestamp, 
        ...
        assertGt(stableBondCoins.balanceOf(client1), client1BalanceBefore, "Position owner should receive excess payment");
