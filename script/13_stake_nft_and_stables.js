...
// Validate arguments
if (!tokenId || !amount) {
  console.error('Usage: node script/13_stake_nft_and_stables.js <tokenId> <amount>');
  console.error('Example: node script/13_stake_nft_and_stables.js 75955146522550863186049403197281544413786813629915328080343312216854220103147 10');
  process.exit(1);
}
...
async function stakeNFTandStables() {
  try {
    ...
    const tx = await nftStakingAndBorrowing.stakeNFTandStables(bondNFTAddress, tokenId, amountInt, { gasLimit });
